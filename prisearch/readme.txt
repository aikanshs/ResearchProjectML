...
Step 2. Download xampp server from the given link:
		https://www.apachefriends.org/download.html
Step 3: Go to the folder where xampp is installed and find htdocs folder. Inside htdocs folder extract the project and save it.
Step 4:	Run xampp application and click Start button in Apache.
